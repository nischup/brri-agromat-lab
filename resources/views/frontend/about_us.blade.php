...
@section('content')
                    ...
                    <div class="col-lg-7 col-xl-6">
                        <div class="about-content">
                            ...
                            <div class="item-area">
                                <div class="item">
                                    <div class="thumb">
                                        <img src="{{ asset('frontend/images/about/01.png') }}" alt="about">
                                    </div>
    ...
    <section class="call-in-section padding-top padding-bottom">
        <div class="container">
            <div class="call-wrapper cl-white bg_img" data-background="{{ asset('frontend/images/call-in/call-bg.png') }}">
            ...
            <div class="team-wrapper row justify-content-between">
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="{{ asset('frontend/images/team/team1.png') }}" alt="team">
                            </a>
                        </div>
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="{{ asset('frontend/images/team/team2.png') }}" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="{{ asset('frontend/images/team/team3.png') }}" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="{{ asset('frontend/images/team/team4.png') }}" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
