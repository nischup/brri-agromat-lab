...
class NeighbourhoodComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('admin.livewire.neighbourhood.index', [
         ...
         // return view('admin.livewire.ProjectModule');
    }
    ...
    public function store()
    {
        ...
        $catalogue = ProjectModule::create([
        ...
        $this->dispatchBrowserEvent('alert', ['type' => 'success',  'message' => 'ProjectModule created successfully!']);
    }
    ...
    public function edit($id)
    {
        ...
        $catalogue = \App\Models\ProjectModule::find($id);
    ...
    public function update()
    {
        ...
        \App\Models\ProjectModule::find($this->editing)->update([
            'title' => $this->title,
        ...
        $this->dispatchBrowserEvent('closeModal');
        $this->dispatchBrowserEvent('alert', ['type' => 'success',  'message' => 'ProjectModule updated successfully!']);
    }
    ...
    public function destroy($id)
    {
        ...
        ProjectModule::where('id', $id)->update(['status' => 1]);

        // $catalogue->delete();

      $this->dispatchBrowserEvent('alert', ['type' => 'success',  'message' => 'ProjectModule Deleted successfully!']);
    }
    ...
    public function p_categoryChanged($value)
    {
        ...
        $this->child_categories = Project::select('id', $this->category_column, 'name')->where('company_id', $value)->get()->toArray();
    }
    ...
    public function mount()
    {
        ...
        $this->company = Company::select('id', $this->category_column, 'name')->get()->toArray();
    }
}
